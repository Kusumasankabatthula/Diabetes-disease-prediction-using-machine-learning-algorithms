...
ClientRegister_Model,identity_theft_detection,detection_ratio,detection_accuracy 
...
def train_model(request): 
    ...
    detection_accuracy.objects.create(names="Extra Tree Classifier", ratio=accuracy_score(y_test, 
etcpredict) * 100) 
